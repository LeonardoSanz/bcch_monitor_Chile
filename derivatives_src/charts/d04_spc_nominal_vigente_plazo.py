...
CHART_ID = "d04_spc_nominal_vigente_plazo"
TITLE = "D04 - Montos vigentes SPC nominal por plazo residual"
...
def build_figure(df: pd.DataFrame, apertura: str = APERTURA_TOTAL):
    ...
    title = f"BANCOS. MONTOS VIGENTES EN DERIVADOS SPC-CLP POR PLAZO RESIDUAL. {apertura.upper()}"
