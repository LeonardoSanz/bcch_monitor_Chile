...
from derivatives_src.charts.d02_fx_helpers import DER_BD_SPC_04, MM_USD, PLAZO_ORDER, _filter_dates, _base, normalize_plazo, stacked_bar_line
...
CHART_ID = "d02_ndf_transados_netos_plazo"
TITLE = "D02 - Montos transados netos NDF USD/CLP con no residentes por plazo contractual"
SOURCE_TAG = "DER_BD_SPC_04"
...
def build_dataframe(client: BCCHClient | None, registry: SeriesRegistry, start_date: str, end_date: str, demo: bool = False) -> pd.DataFrame:
    raw = fetch_bde_table(DER_BD_SPC_04).long.copy()
