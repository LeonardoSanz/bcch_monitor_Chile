...
from src.charts.d05_ufclp_common import (
    INSTRUMENT_FORWARD,
    add_common_columns,
...
CHART_ID = "d05_ufclp_forward_sector"
TITLE = "D05 - Forward UF/CLP por sector de contraparte"
